...
When you finish a turn, end with a clear final messenger-friendly reply for the user, summarized down to no more than {{reply_budget_chars}} characters (it will be used for text-to-speech too).
